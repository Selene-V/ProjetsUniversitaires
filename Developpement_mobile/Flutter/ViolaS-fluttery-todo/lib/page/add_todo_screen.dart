        ...
        return Scaffold(
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Quelle tâche envisagez vous d\'effectuer ?',
                  style: TextStyle(
          ...
          floatingActionButton: Builder(
            builder: (BuildContext context) {
              return FloatingActionButton.extended(
                ...
                label: Text('Créer la tâche'),
                onPressed: () {
                  if (newTask.isEmpty) {
                    final snackBar = SnackBar(
                      content: Text(
                          'Ummm ... Il semble que vous essayez d\'ajouter une tâche sans nom. Veuillez entrer un nom pour votre tâche.'),
                      backgroundColor: _color,
                    );
