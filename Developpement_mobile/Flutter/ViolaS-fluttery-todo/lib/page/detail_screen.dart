                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Hero(
                          ...
                          child: Text(
                            "${model.getTotalTodosFrom(_task)} tâches",
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Effacer cette catégorie ?'),
              content: SingleChildScrollView(
                child: ListBody(
                  children: <Widget>[
                    Text(
                        'Si vous supprimez cette catégorie, toutes les tâches de cette dernière seront effacer.'),
                  ],
                ),
              ),
              actions: <Widget>[
