...
class _EditCardScreenState extends State<EditTaskScreen> {
  final  btnSaveTitle = "Sauvegarder";
  String newTask;
  Color taskColor;
  IconData taskIcon;
        ...
        return Scaffold(
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'La catégorie vous aidera à regrouper les tâches liées !',
                  style: TextStyle(
                ...
                onPressed: () {
                  if (newTask.isEmpty) {
                    final snackBar = SnackBar(
                      content: Text(
                          'Ummm ... Il semble que vous essayez d\'ajouter une catégorie sans nom. Veuillez entrer un nom pour votre catégorie.'),
                      backgroundColor: taskColor,
                    );
